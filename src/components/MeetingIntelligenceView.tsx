  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
        ...
        <div className="flex flex-wrap gap-2 mt-6 pt-5 border-t border-slate-800">
          ...
          >
            ...
            ✅ Tasks &amp; Next Steps ({actionItems.length})
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {analysis.keyTopics?.map((topic, idx) => (
            <div key={idx} className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl">
              ...
              <h4 className="text-sm font-bold text-slate-100 mt-1 mb-2">{topic.topic}</h4>
      ...
      {activeTab === 'email' && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
            <div>
              <h3 className="text-sm font-bold text-slate-100">Ready-to-Send Follow-up Email</h3>
              <p className="text-xs text-slate-400">Pre-drafted executive recap formatted for attendee distribution</p>
            </div>
            <button
              onClick={handleCopyEmail}
              className="flex items-center gap-1.5 px-3.5 py-2 bg-amber-600 hover:bg-amber-500 text-white rounded-xl text-xs font-semibold transition-all shadow-md cursor-pointer active:scale-95"
            >
      ...
      {activeTab === 'transcript' && rawTranscript && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
          <h3 className="text-sm font-bold text-slate-100 mb-3">Full Recorded Transcript</h3>
